...
namespace DGRA_V1.Common
{
    ...
    {
        SuccessCode = 0,
        //CalDailySolarKPICompFail,
        CDSKFailFetchSiteFormulas = 1101,
        CDSKFailExecuteLoopFormulas,
        CDSKFailFetchInvAcDc,
        ...
        CDSKFailCalculatePlantTempCorr,
        CDSKFailDelTempCorr,
    ...
    public class ErrorCodes
    {
        public static Dictionary<ErrorCode, string> ErrorDescriptionMap = new Dictionary<ErrorCode, string>
        {
            ...
            {ErrorCode.CDSKFailCalculatePlantTempCorr, "Exception while calculating plant temperature corrected pr in getTemperatureCorrectedPR function." },
            ...
            {ErrorCode.CDSKFailFetchInvAcDc, "Exception while getting inverter and ac_dc capicity from solar_ac_dc_capicity table in CalculateDailySolarKPI function" },
