    ...
    public class LoginBS : iLoginBS
    {
        ...
        public async Task<int> EmailReportTimeChangeSetting(string dailytime, string windweeklytime, string solarweeklytime, string windweekday, string solarweekday, string firstReminderTime, string secondReminderTime, string username, int user_id, string role,string SolarMonthlyTime,string WindMonthlyTime, string solarmonthdate,string windmonthdate,int EmailLogId)
        {
            try
            {
                using (var repos = new LoginRepository(getDB))
                {
                    return await repos.EmailReportTimeChangeSetting(dailytime, windweeklytime, solarweeklytime, windweekday, solarweekday, firstReminderTime, secondReminderTime, username, user_id, role, SolarMonthlyTime, WindMonthlyTime,solarmonthdate,windmonthdate, EmailLogId);
