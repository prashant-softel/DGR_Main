...
namespace DGRAPIs.Models
{
    public class WindDailyGenReports
    {
        ...
        public dynamic usmh_loss { get; set; }
        public dynamic smh_loss { get; set; }
        public dynamic others_loss { get; set; }
        public dynamic igbdh_loss {get;set;}
        public dynamic egbdh_loss { get; set; }
        public dynamic loadShedding_loss { get; set; }
        public dynamic total_loss { get; set; }
        public dynamic total_hrs { get; set; }
    }
